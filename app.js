...
function progressInterva() {
    if (count === 100 && percentWidth === 100) {
        ...
        percent.textContent = "Happy anniversary 6th - Lankhai ♥";
        ...
        setTimeout(() => {
            textBtn.textContent = "Ấn vào đâyyy !";
        ...
        // Kiểm tra khi progress đạt 99%
        if (count === 99) {
            clearInterval(progressLoad); // Tạm dừng progress
            ...
            // Điều chỉnh độ đậm của ảnh nền
            document.body.style.opacity = count / 100; // Tăng opacity từ 0 đến 1
        }
    }
}
...
noButton.onclick = function () {
    ...
    // Tiếp tục progress
    progressLoad = setInterval(progressInterva, 100);
}
